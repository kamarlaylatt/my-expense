...
export const updateExpenseSchema = z.object({
  ...
  categoryId: z
    ...
    .optional(),
  currencyId: z
    .number({ invalid_type_error: "Currency ID must be a number" })
    .int()
    .positive()
    .optional()
    .nullable(),
...
export const createCurrencySchema = z.object({
  ...
  usdExchangeRate: z
    .number({
      required_error: "USD exchange rate is required",
      invalid_type_error: "USD exchange rate must be a number",
    })
    .positive("USD exchange rate must be positive"),
});
